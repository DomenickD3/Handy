...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::audio::change_wake_word_setting,
            ...
            commands::audio::start_hands_free,
            commands::audio::stop_hands_free,
            commands::audio::toggle_hands_free_pause,
            commands::audio::is_hands_free_running,
            commands::audio::is_hands_free_paused,
